<%-- 
    Document   : contact_page_list
    Created on : Jun 12, 2023, 11:00:51 PM
...
.card-body {
  ...
  <%
    ...
    int counter=1;
      ...
      try
      {
          Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from contact_page";
   ...
   <th scope="row"><%=counter++%></th>
         ...
         <td><input type="text" name="nm" value="<%=rs.getString("nm")%> " class="form-control"></td>
           <td><input type="text" name="email" value="<%=rs.getString("email")%>" class="form-control"></td>
       <td><input type="text" name="msg" value="<%=rs.getString("msg")%>" class="form-control"></td>
