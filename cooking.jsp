<%-- 
    Document   : cooking
    Created on : Jun 10, 2023, 6:51:37 PM
...
<div class="container">
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Choose Cooking Service</h3>
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_services where category_nm='Cooking'";
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <input type="hidden" value="<%=rs.getString("category_nm")%>" name="cook" >
