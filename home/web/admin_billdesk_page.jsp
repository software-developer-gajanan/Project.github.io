<%-- 
    Document   : admin_billdesk_page
    Created on : Jun 15, 2023, 7:49:28 PM
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from booking, add_services, card_pay";
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-9 text-secondary">
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-4"><a class="btn btn-primary " target="__blank" href="">Download</a></div>
