<%-- 
    Document   : painting
    Created on : Jun 11, 2023, 9:34:23 AM
...
<div class="container">
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Choose Painting Service</h3>
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_services where category_nm='Painting'";
...
<div class="card" >
  ...
  <input type="hidden" value="<%=rs.getString("price")%>" name="price" >
    <input type="hidden" value="Painting" name="cook" >
