<%-- 
    Document   : upi_billdesk
    Created on : Jun 11, 2023, 12:37:58 PM
            ...
            %>
                <div class="card-body">
                    <form action="" method="post">
                         <a href="online_pay.jsp" style="float:right;" class="btn btn-outline-danger">X</a>
                  ...
                  <div class="col-sm-9 text-secondary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4"><a class="btn btn-primary " target="__blank" href="home_page.jsp">Back to Home </a></div>
