<%-- 
    Document   : plumbing
    Created on : Jun 11, 2023, 9:35:40 AM
...
<div class="container">
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Choose Plumbing Service</h3>
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="select * from add_services where category_nm='Plumbing'";
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <input type="hidden" value="Plumbing" name="cook" >
