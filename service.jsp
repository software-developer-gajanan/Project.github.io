...
<div class="container">
<h3 class="mb-lg-4 mb-md-3 mb-sm-2 mb-2">Choose Your Service</h3>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">We provide trustable and cost friendly Cooking workers.</p>
    <a href="cooking.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  <img class="card-img-top" src="images/Home-Cleaning-Service.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Cleaning</h5>
    <p class="card-text">We provide trustable and cost friendly Cleaning workers.</p>
    <a href="cleaning.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban1">
<div class="card" >
  <img class="card-img-top" src="images/gardening.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Gardening</h5>
    <p class="card-text">We provide trustable and cost friendly Gardening workers.</p>
    <a href="gardening.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
...
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">We provide trustable and cost friendly Driving workers.</p>
    <a href="driving.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  <img class="card-img-top" src="images/paint2.jpg" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Painting</h5>
    <p class="card-text">We provide trustable and cost friendly Painting workers.</p>
    <a href="painting.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
<div class="col-md-4 col-sm-12 w3_ban">
<div class="card" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">We provide trustable and cost friendly Plumbing workers.</p>
    <a href="plumbing.jsp" class="btn btn-primary">Explore</a>
  </div>
</div>
</div>
</div>
