<%-- 
    ...
    Created on : May 21, 2023, 8:56:18 PM
...
.card-body {
  ...
  <%
   ...
   <th scope="row"><%=counter++%></th>
         ...
         <td><input type="text" name="first_nm" value="<%=rs.getString("first_nm")%>" class="form-control"><input type="text" name="lst_nm" value="<%=rs.getString("lst_nm")%>" class="form-control"> </td>
      ...
      <td><input type="text" name="email" value="<%=rs.getString("email")%>" class="form-control"></td>
         ...
         <td><input type="submit" name="btn" value="Update" class="btn btn-success" class="form-control"></td>
